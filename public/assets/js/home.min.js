...
const elements=[...(headline?[...headline.children].filter((el)=>el.tagName!=='H1'):[]),
stats,
...
if(matchMedia('(prefers-reduced-motion: reduce)').matches)return null;
const list=document.querySelector('.home-page > header > section > div > ul[aria-label="Platform highlights"]');
if(!list)return null;
