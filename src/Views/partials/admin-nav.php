 ...
 * on the active link. Included via require in the admin shell (index.php).
 */
?>
<nav aria-label="Admin navigation">
  <ul>
    ...
    <li><a href="/admin/tos"<?= str_starts_with($currentPage, '/admin/tos') ? ' aria-current="page"' : '' ?>><i class="fa-solid fa-file-contract" aria-hidden="true"></i> TOS</a></li>
  </ul>
</nav>
