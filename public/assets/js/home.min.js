...
CounterAnimation.#runAll(this.#counters);}},{threshold:0.5});
...
#nextBtn;
#desktop;
#reducedMotion;#rafPending=false;#cardStride=0;#abortController=new AbortController();
...
this.#nextBtn.disabled=clientW>=scrollW-1;});}#scrollByCards(direction){
...
behavior:this.#reducedMotion.matches?'auto':'smooth',});}#resetScroll(){
requestAnimationFrame(()=>{
...
list.scrollLeft=0;
this.#prevBtn.disabled=true;
this.#nextBtn.disabled=clientW>=scrollW-1;});}#activate(){
this.#list.dataset.arrows='';
this.#resetScroll();}#deactivate(){
delete this.#list.dataset.arrows;
this.#resetScroll();}#handlePrev=()=>this.#scrollByCards(-1);#handleNext=()=>this.#scrollByCards(1);#handleScroll=()=>{
if(this.#rafPending)return;
this.#rafPending=true;
requestAnimationFrame(()=>{
this.#updateArrowState();
