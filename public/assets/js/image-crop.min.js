...
#labelEl;
#confirmIcon;
#descEl;#mode=null;#file=null;#objectUrl=null;#focalX=50;#focalY=50;#aspectRatio=1.5;#repositionImageId=null;#layout=null;#frameLeft=0;#frameTop=0;#savedScrollY=0;#onConfirmCallback=null;#confirmed=false;#dragging=false;#startX=0;#startY=0;#startFrameLeft=0;#startFrameTop=0;#abortController=new AbortController();
constructor(dialog){
this.#dialog=dialog;
...
this.#dialog.close();}#updateHintText(){
if(!this.#descEl)return;
const shape=this.#aspectRatio===1?'square':'3:2';
this.#descEl.textContent=`Drag to choose which part is visible in the ${shape} frame.`;}#layoutCrop(){
...
frameH=dispH;
frameW=dispH*this.#aspectRatio;}else{
frameW=dispW;
...
this.#viewport.focus();}#openReposition(imgSrc,focalX,focalY,imageId,opts={}){
...
this.#updateFocalFromFrame();};#handlePointerUp=()=>{this.#dragging=false;};#handleKeydown=(e)=>{
const step=1;
let handled=false;
