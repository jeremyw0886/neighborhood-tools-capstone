...
list.scrollLeft=0;
this.#prevBtn.disabled=true;
this.#nextBtn.disabled=clientW>=scrollW-1;});}#deactivate(){
...
list.scrollLeft=0;
this.#prevBtn.disabled=true;
this.#nextBtn.disabled=clientW>=scrollW-1;});}#handlePrev=()=>this.#scrollByCards(-1);#handleNext=()=>this.#scrollByCards(1);#handleScroll=()=>{
if(this.#rafPending)return;
this.#rafPending=true;
requestAnimationFrame(()=>{
this.#updateArrowState();
