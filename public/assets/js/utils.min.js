...
class StyleManager{#sheet=new CSSStyleSheet();#ruleMap=new Map();
constructor(){
...
#main;
#btn;
#sentinel;#abortController=new AbortController();#rafId=0;#lastProgress=-1;
constructor(main){
this.#main=main;
...
this.#btn.removeAttribute('data-visible');}else{
this.#btn.setAttribute('data-animated','');
this.#btn.setAttribute('data-visible','');}},{rootMargin:'0px'});
...
ScrollToTop.#instance=null;}#updateProgress(){
...
`--progress:${raw};--progress-int:${rounded}`);}}#handleScroll=()=>{
cancelAnimationFrame(this.#rafId);
this.#rafId=requestAnimationFrame(()=>this.#updateProgress());};#handleClick=()=>{
window.scrollTo({top:0,behavior:'smooth'});};#handleContentSwap=()=>{
