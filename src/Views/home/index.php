    ...
    <section id="popular-picks" aria-labelledby="popular-heading">
      ...
      <div id="tool-cards" role="list">
        ...
        <?php else: ?>
          <article class="tool-card" role="listitem">
            <figure class="tool-card-image">
              <img src="/assets/images/tool-placeholder.png" alt="Cordless Drill" loading="lazy">
              <button class="tool-bookmark" type="button" aria-label="Bookmark Cordless Drill">
                <i class="fa-regular fa-bookmark" aria-hidden="true"></i>
              </button>
            </figure>
            <div class="tool-card-info">
              ...
              <footer class="tool-card-footer">
                ...
                <img src="/assets/images/avatar-placeholder.png" alt="Owner" class="tool-owner-avatar" loading="lazy">
              </footer>
            </div>
          </article>
          <article class="tool-card" role="listitem">
            <figure class="tool-card-image">
              <img src="/assets/images/tool-placeholder.png" alt="Circular Saw" loading="lazy">
              <button class="tool-bookmark" type="button" aria-label="Bookmark Circular Saw">
                <i class="fa-regular fa-bookmark" aria-hidden="true"></i>
              </button>
            </figure>
            <div class="tool-card-info">
          ...
          <article class="tool-card" role="listitem">
            <figure class="tool-card-image">
              <img src="/assets/images/tool-placeholder.png" alt="Pressure Washer" loading="lazy">
              <button class="tool-bookmark" type="button" aria-label="Bookmark Pressure Washer">
                <i class="fa-regular fa-bookmark" aria-hidden="true"></i>
              </button>
            </figure>
            <div class="tool-card-info">
          ...
          <article class="tool-card" role="listitem">
            <figure class="tool-card-image">
              <img src="/assets/images/tool-placeholder.png" alt="Chainsaw" loading="lazy">
              <button class="tool-bookmark" type="button" aria-label="Bookmark Chainsaw">
                <i class="fa-regular fa-bookmark" aria-hidden="true"></i>
              </button>
            </figure>
            <div class="tool-card-info">
          ...
          <article class="tool-card" role="listitem">
            <figure class="tool-card-image">
              <img src="/assets/images/tool-placeholder.png" alt="Extension Ladder" loading="lazy">
              <button class="tool-bookmark" type="button" aria-label="Bookmark Extension Ladder">
                <i class="fa-regular fa-bookmark" aria-hidden="true"></i>
              </button>
            </figure>
            <div class="tool-card-info">
          ...
          <article class="tool-card" role="listitem">
            <figure class="tool-card-image">
              <img src="/assets/images/tool-placeholder.png" alt="Leaf Blower" loading="lazy">
              <button class="tool-bookmark" type="button" aria-label="Bookmark Leaf Blower">
                <i class="fa-regular fa-bookmark" aria-hidden="true"></i>
              </button>
            </figure>
            <div class="tool-card-info">
