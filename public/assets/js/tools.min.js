...
#dropZone;
#fileInput;
#dataContainer;#queuedPhotos=[];#repositionIndex=-1;#dragItem=null;#dragCounter=0;#abortController=new AbortController();
...
this.#dataContainer.appendChild(yInput);}}#updateHint(){
...
this.#syncFormInputs();
this.#updateHint();}#handleQueueClick=(e)=>{
...
const blobUrl=URL.createObjectURL(entry.file);
NT.crop.openReposition(blobUrl,entry.focalX,entry.focalY,`queue-${this.#repositionIndex}`);}};#handleDragStart=(e)=>{
...
if(!label)continue;
if(r.value===imageId){
label.innerHTML='<i class="fa-solid fa-star" aria-hidden="true"></i> Primary';}else{
