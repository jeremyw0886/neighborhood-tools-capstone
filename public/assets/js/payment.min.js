...
#form;
#submitBtn;
#messageEl;#stripe;#elements;#btnLabel;#submitting=false;#abortController=new AbortController();
...
PaymentForm.#instance=null;}#handleSubmit=async(e)=>{
e.preventDefault();
...
confirmParams:{
return_url:`${window.location.origin}/payments/complete`,},}));}catch{
