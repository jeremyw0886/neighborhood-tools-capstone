...
loaded=true;
announceBadge(data.unread);}}catch{
loaded=false;
updateContent([]);}finally{
loading=false;}};
...
NT.focus.announce(
count>0
?`${count} unread notification${count !== 1 ? 's' : ''}`:'No unread notifications');};
