# Seeded Image Assets — Licensing & Attribution

This directory contains placeholder images used for development and demonstration purposes.
...
## Avatars (`vectors/avt_*`)

Generated with [Avataaars Generator](https://getavataaars.com/).

**License:** Free for personal and commercial use.
**Design:** Pablo Stanley | **Code:** Fang-Pen Lin
**Original library:** [avataaars.com](https://avataaars.com)

## Tool Category Icons (`vectors/vec_*`)

AI-generated SVG icons created with [SVG AI Icon Generator](https://www.svgai.org/ai-icon-generator) under a paid plan.
