...
#form;
#submit;#verified=false;#timerId=null;
...
if(!this.#verified)this.#enable();},5000);}
static init(){
...
TurnstileGuard.#instance=null;}#enable(){
this.#submit.disabled=false;
this.#submit.removeAttribute('aria-busy');}#handleVerify=()=>{
this.#verified=true;
this.#enable();};#handleExpire=()=>{
this.#verified=false;
this.#submit.disabled=true;
this.#submit.setAttribute('aria-busy','true');};#handleError=()=>{
this.#enable();};}
TurnstileGuard.init();